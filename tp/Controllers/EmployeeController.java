          ...
          public void actionPerformed(ActionEvent e) {
            ...
            if (isAdded) {
              ...
              JOptionPane.showMessageDialog(
                  null, "Employee " + em + " Added Nice!", "New", JOptionPane.INFORMATION_MESSAGE);

            } else {
              JOptionPane.showMessageDialog(
                  null, "u cant add employee " + em, "New", JOptionPane.ERROR_MESSAGE);
            }
          }
        });
  }
        ...
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            if (isDeleted) {
              ...
              JOptionPane.showMessageDialog(
                  null,
                  "Employee id " + id + " deleteed!",
                  "Delete",
                  JOptionPane.INFORMATION_MESSAGE);

            } else {
              JOptionPane.showMessageDialog(
                  null, "  u cant  delete Employee --> id " + id, "Delete", JOptionPane.ERROR_MESSAGE);
            }
          }
        });
  }
        ...
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            if (isUpdated) {
              ...
              JOptionPane.showMessageDialog(
                  null,
                  "Employee id " + id + " msj with values: " + em,
                  "Update",
                  JOptionPane.INFORMATION_MESSAGE);
              ...
              JOptionPane.showMessageDialog(
                  null,
                  "pas posibilite de msj  Employee --> id " + id + " avec values: " + em,
                  "Update",
